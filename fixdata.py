...
# Поскольку стандартная стоимость продукта не указана, предполагаем, что ее нет в данных.
...
# Без данных о себестоимости, пропускаем этот расчет
...
# 11. Разница с себестоимостью = Цена за единицу товара - Стандартная стоимость продукта
# Так как нет данных о стандартной стоимости, пропускаем этот расчет
